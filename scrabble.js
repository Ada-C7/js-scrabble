...
Scrabble.prototype.highestScoreFrom = function(arrayOfWords) {
  ...
  for (var i = 0; i < arrayOfWords.length; i++) {
    var currentWordScore = this.score(arrayOfWords[i]);
...
//i tried writing a function that would return the winning word if there was a single winning word but it didn't work.
  // var singleWinningWord = function (){
...
// console.log("Player 1 played: 'Marisol', and received " + player1.score("apple") + " points.")
// console.log("Player 1's highest scoring word was: " + player1.highestScoreFrom([ "qqqq", "zzzz", "apple"]))
